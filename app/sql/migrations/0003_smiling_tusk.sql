ALTER TABLE "get_ideas_likes" RENAME TO "gpt_ideas_likes";--> statement-breakpoint
ALTER TABLE "gpt_ideas_likes" DROP CONSTRAINT "get_ideas_likes_gpt_idea_id_gpt_ideas_gpt_idea_id_fk";
--> statement-breakpoint
ALTER TABLE "gpt_ideas_likes" DROP CONSTRAINT "get_ideas_likes_profile_id_profiles_profile_id_fk";
--> statement-breakpoint
ALTER TABLE "gpt_ideas_likes" DROP CONSTRAINT "get_ideas_likes_gpt_idea_id_profile_id_pk";--> statement-breakpoint
